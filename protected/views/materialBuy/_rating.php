	...
	<div class="span5 dark-blue">
		...
		<table>	
			<tr class="white">
				...
				<td class="span1" align="center"><?php echo GetName::getRating($model->supplier->id)->averageRating; ?></td>
				<td class="subtitle span1">Отзывов</td>
				<td class="span1" align="center"><?php echo GetName::getRating($model->supplier->id)->count; ?></td>
			</tr>
		</table>
		<div>
		<?php echo CHtml::link("Посмотреть профиль поставщика",array('user/profile','id'=>$model->supplier_id), array('class'=>'btn btn-block pull-left')); ?>
		</div>
	</div>
	<div class="span6">
